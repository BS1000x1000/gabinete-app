...
<style>
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .header { display: flex; justify-content: space-between; align-items: flex-start; border-bottom: 2px solid #7c6fd6; padding-bottom: 20px; margin-bottom: 28px; }
  .emisor h1 { font-size: 20px; font-weight: 700; color: #7c6fd6; margin-bottom: 6px; }
  .emisor p { line-height: 1.6; color: #444; }
  .factura-badge { text-align: right; }
  .factura-badge .label { font-size: 10px; text-transform: uppercase; letter-spacing: 1px; color: #888; }
  .factura-badge .numero { font-size: 28px; font-weight: 700; color: #7c6fd6; }
  .factura-badge .fecha { font-size: 11px; color: #666; margin-top: 4px; }

  .parties { display: grid; grid-template-columns: 1fr 1fr; gap: 24px; margin-bottom: 28px; }
  .party-box { background: #f9f8ff; border: 1px solid #e8e4f8; border-radius: 8px; padding: 16px; }
  .party-box h3 { font-size: 10px; text-transform: uppercase; letter-spacing: 1px; color: #7c6fd6; margin-bottom: 8px; }
  .party-box p { line-height: 1.7; color: #333; }

  .concepto-box { background: #f9f8ff; border: 1px solid #e8e4f8; border-radius: 8px; padding: 16px; margin-bottom: 28px; }
  .concepto-box h3 { font-size: 10px; text-transform: uppercase; letter-spacing: 1px; color: #7c6fd6; margin-bottom: 8px; }
  .concepto-box .periodo { font-size: 11px; color: #888; margin-top: 4px; }
  ...
  .totales tr { border-bottom: 1px solid #eee; }
  .totales tr.subtotal td:last-child { font-weight: 600; }
  .totales tr.exencion td { font-size: 10px; color: #888; font-style: italic; border-bottom: none; padding-top: 2px; }
  .totales tr.retencion td:last-child { color: #ef4444; }
  .totales tr.total-row td { font-weight: 700; font-size: 14px; color: #7c6fd6; border-top: 2px solid #7c6fd6; border-bottom: none; }

  .iban-box { margin-bottom: 28px; background: #f0fdf4; border: 1px solid #bbf7d0; border-radius: 8px; padding: 14px 16px; }
  .iban-box h3 { font-size: 10px; text-transform: uppercase; letter-spacing: 1px; color: #059669; margin-bottom: 6px; }
  .iban-box p { font-size: 13px; font-weight: 600; color: #065f46; letter-spacing: 1px; }

  .footer { border-top: 1px solid #e8e4f8; padding-top: 16px; font-size: 10px; color: #999; line-height: 1.6; }
</style>
</head>
<body>
<div class="page">
